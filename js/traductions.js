...
const TRADUCTIONS = {
  ...
  "pdf_fondements_titre": { fr: "Références dans le <em>Document final</em> du Synode",
                            en: "References in the Synod <em>Final Document</em>" },
  ...
  "pdf_fondements_source": { fr: "Citations extraites du <em>Document final</em> du Synode sur la synodalité (2024). © Secrétariat général du Synode des évêques.",
                             en: "Quotations from the <em>Final Document</em> of the Synod on Synodality (2024). © General Secretariat of the Synod of Bishops." }
