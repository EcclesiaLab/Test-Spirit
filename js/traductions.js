...
const TRADUCTIONS = {
  ...
  "pdf_pistes":       { fr: "Pistes de progression", en: "Pathways for progress" },
  ...
  "pdf_pistes_validation": { fr: "En attendant, toutes les phrases issues du Document final du Synode sur la synodalité ont été réunies dans les pages suivantes comme pistes de réflexion. Elles ont été validées par un panel de 50 théologiens et théologiennes issus du monde entier lors de la phase théorique de création de l'outil.",
                             en: "In the meantime, all the phrases drawn from the Final Document of the Synod on Synodality have been gathered on the following pages as prompts for reflection. They were validated by a panel of 50 theologians from around the world during the theoretical phase of the tool's creation." },
  "pdf_pistes_groupe": { fr: "Pour une utilisation en groupe, chacun fait sa propre évaluation sur SPIRIT, puis les PDF individuels peuvent être confrontés afin d'en tirer des pistes de progression.",
  ...
  "diagnostic_pistes_note": { fr: "Les pistes de progression personnalisées sont en cours de développement. En attendant, des phrases issues du Document final du Synode — validées par un panel de 50 théologiens et théologiennes — sont proposées comme pistes de réflexion dans le PDF (dernière page).",
                              en: "Personalised pathways for progress are still in development. In the meantime, phrases from the Synod Final Document — validated by a panel of 50 theologians — are offered as prompts for reflection in the PDF (last page)." },
  ...
  "pdf_fondements_titre": { fr: "Références dans le Document final du Synode",
                            en: "References in the Synod Final Document" },
  "pdf_fondements_intro": { fr: "Voici les passages références servant de fondement à l'outil, validés par un panel de 50 théologiens et théologiennes :",
                            en: "Here are the reference passages that serve as the foundation of the tool, validated by a panel of 50 theologians:" },
